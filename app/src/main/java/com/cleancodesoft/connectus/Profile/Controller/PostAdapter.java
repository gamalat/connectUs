...
public class PostAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public PostAdapter(List<PostModel> post) {
        this.post = post;
    }

    public PostAdapter(List<PostModel> post, Context context) {
        this.post = post;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        menuItemViewHolder.post_text.setText(post.get(i).getPostText());
        menuItemViewHolder.txt_name.setText(post.get(i).getUserName());
